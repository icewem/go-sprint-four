...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	averageSpeedKmPerHour := swimmingMeanSpeed(lengthPool, countPool, duration)

	// Расчет потраченных калорий при плавании
	calories := (averageSpeedKmPerHour + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return calories
}
